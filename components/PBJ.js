...
export default function PBJ ({navigation}) {
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity style = {styles.buttons}>
        <Text style = {styles.aboutParagraph}>
          Pickup will be 1/9/2022, at 11 AM, at the store. Are you sure you want to purchase? If the pick-up is not completed, there will only be a partial refund. 
        </Text>
      </TouchableOpacity>
